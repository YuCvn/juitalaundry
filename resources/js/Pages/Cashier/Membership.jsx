                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-[#06b6d4] hover:-translate-y-1 transition-transform duration-200 rounded-xl p-6 text-white shadow-sm flex justify-between items-center cursor-default">
                        <div>
                            ...
                            <h3 className="text-4xl font-bold">{formatRp(totalActiveBalance)}</h3>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredMemberships.map((member) => (
                                    <div key={member.id} className="bg-white border border-gray-200 rounded-2xl p-5 flex flex-col shadow-sm hover:shadow-md transition-shadow">
                                        ...
                                        <div className="mb-4">
                                            <h4 className="text-xl font-bold text-gray-800 mb-2">{member.full_name}</h4>
                                        ...
                                        <div className="bg-blue-50/70 border border-blue-100 rounded-xl p-3 mb-5">
                                            ...
                                            <p className="font-bold text-blue-700 text-xl">{formatRp(member.balance)}</p>
                                        </div>
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            {modalMode === 'history' ? (
                                                ...
                                                return (
                                                    <div key={history.id} className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-4 border border-gray-100 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow gap-4 sm:gap-0">
                                                        ...
                                                        <div className="text-left sm:text-right ml-16 sm:ml-0">
                                                            <p className="font-extrabold text-[#10b981] text-lg">+ {formatRp(history.amount)}</p>
                                                            <p className="text-xs text-gray-500 font-medium mt-0.5 bg-gray-100 inline-block px-2 py-1 rounded-md sm:bg-transparent sm:px-0 sm:py-0">
                                                                Saldo Akhir: <span className="font-bold">{formatRp(history.final_balance)}</span>
                                                            </p>
                                                        </div>
                                ...
                                <div>
                                    ...
                                    {modalMode === 'topup' && <p className="text-gray-600 mb-6 font-medium">{data.full_name}</p>}
                                        ...
                                        {modalMode === 'topup' ? (
                                            <>
                                                <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-4">
                                                    ...
                                                    <p className="text-3xl font-bold text-blue-600">{formatRp(data.current_balance)}</p>
                                                </div>
                                            ...
                                            <>
                                                ...
                                                {modalMode === 'edit' ? (
                                                    <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-4 mt-2">
                                                        <p className="text-xs text-gray-500 font-semibold mb-1">Saldo Saat Ini</p>
                                                        <p className="text-2xl font-bold text-blue-600 mb-2">{formatRp(data.balance)}</p>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="relative">
                                                            ...
                                                            <input type="number" value={data.balance} onChange={(e) => setData('balance', e.target.value)} placeholder="100000" className="pl-12 w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#00d2ff] focus:border-[#00d2ff] outline-none transition-all" />
                                                        </div>
                                                    </div>
                                                )}
                                            </>
