                                ...
                                >
                                    <div>
                                        <div className="flex items-center">
                                            ...
                                            {order.status?.toLowerCase() === 'pending' || order.status?.toLowerCase() === 'menunggu' ? (
                                            ...
                                            ) : order.status?.toLowerCase() === 'processing' || order.status?.toLowerCase() === 'diproses' || order.status?.toLowerCase() === 'dalam proses' ? (
                                                <span className="ml-2 flex items-center gap-1 text-[10px] bg-yellow-200 border border-yellow-500 text-yellow-700 px-2 py-0.5 rounded font-medium">
                                                ...
                                                <span className="ml-2 text-[10px] bg-orange-100 text-orange-600 px-2 py-0.5 rounded font-normal capitalize">
                                                    {order.status}
                                                </span>
                                            )}
                                        </div>
