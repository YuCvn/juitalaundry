...
export default function AdminLayout({ children, title }) {
    ...
    return (
        <div className="flex h-screen bg-gray-100 font-sans relative">
            ...
            {/* NOTIFIKASI TOAST MELAYANG DI KANAN ATAS */}
                ...
                <nav className="flex-1 overflow-y-auto px-3 py-2 space-y-2">
                    ...
                    <Link 
                        ...
                        className={`flex items-center p-3 rounded-lg transition-all ${!isSidebarOpen && 'justify-center'} ${
                            isActive('/dashboard') ? 'bg-white text-blue-600 shadow-sm font-semibold' : 'text-blue-100 hover:bg-blue-700 font-medium'
                        }`}
                    >
                    ...
                    <Link 
                        ...
                        className={`flex items-center p-3 rounded-lg transition-all ${!isSidebarOpen && 'justify-center'} ${
                            isActive('/laporan-keuangan') ? 'bg-white text-blue-600 shadow-sm font-semibold' : 'text-blue-100 hover:bg-blue-700 font-medium'
                        }`}
                    >
                    ...
                    <Link 
                        href="/pengeluaran" 
                        className={`flex items-center p-3 rounded-lg transition-all ${!isSidebarOpen && 'justify-center'} ${
                            isActive('/pengeluaran') ? 'bg-white text-blue-600 shadow-sm font-semibold' : 'text-blue-100 hover:bg-blue-700 font-medium'
                        }`}
                    >
                    ...
                    {/* LAINNYA SECTION (Pengaturan, Kelola Kasir, Log Out) */}
                    <div className="text-xs font-semibold text-blue-300 mt-6 mb-2 px-3 uppercase tracking-wider">
                    ...
                    <Link 
                        href="/pengaturan" 
                        className={`flex items-center p-3 rounded-lg transition-all ${!isSidebarOpen && 'justify-center'} ${
                            isActive('/pengaturan') ? 'bg-white text-blue-600 shadow-sm font-semibold' : 'text-blue-100 hover:bg-blue-700 font-medium'
                        }`}
                    >
                    ...
                    <Link 
                        href="/kelola-kasir" 
                        className={`flex items-center p-3 rounded-lg transition-all ${!isSidebarOpen && 'justify-center'} ${
                            isActive('/kelola-kasir') ? 'bg-white text-blue-600 shadow-sm font-semibold' : 'text-blue-100 hover:bg-blue-700 font-medium'
                        }`}
                    >
                    ...
                    {/* Tombol Log Out sudah dipindah ke sini dan desain disamakan */}
                    <Link 
                        href="/logout" 
                        method="post" 
                        as="button"
                        className={`w-full flex items-center p-3 rounded-lg transition-all ${!isSidebarOpen && 'justify-center'} text-blue-100 hover:bg-blue-700 font-medium`}
                    >
